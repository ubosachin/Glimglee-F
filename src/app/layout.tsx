...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "buy customized gifts online",
    "luxury gift hampers online",
    "scented soy wax candles India",
    "floating glass photo frame",
    "custom photo frame online",
    "handcrafted gifts for couples",
    "couple anniversary gifts India",
    "birthday gift hampers for girlfriend",
    "birthday gift hampers for boyfriend",
    "resin pooja thali handcrafted",
    "wedding keepsakes and hampers",
    "corporate gifting hampers India",
